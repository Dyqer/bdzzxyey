...
<body>
<form action="action/danye_action.php" method="post" enctype="multipart/form-data" onSubmit="return add_danye_check()">
  <input name="lanmu" type="hidden" value="<?php echo $lanmu?>">
  <input name="action" type="hidden" value="add">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="edit_tr">
      <td class="edit_t"><span class="edit_title">标&nbsp;&nbsp;&nbsp;&nbsp;题：</span></td>
      <td><input type="text" name="lc_title" class="edit_input" id="lc_title" style="width:60%">
        &nbsp;&nbsp;
    ...
    <tr class="edit_tr">
      ...
      <td><div id="lc_content">
        ...
        <div id="lc_phone_content" style="display: none">
          <textarea name="lc_phone_content" style="height:300px; width:750px"></textarea>
        </div></td>
    </tr>
    <tr class="edit_tr">
     ...
     <tr class="edit_tr">
      ...
      <td><input type="text" name="lc_url" class="edit_input" style="width:600px;">
      </td>
    </tr>
    
    <?php echo get_customfields('danye')?>
    <tr class="sub_tr">
