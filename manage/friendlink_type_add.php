...
SetSysEvent('frinedlink_type_add');//添加日志功能
?>
<!doctype html>
<html>
<head>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="edit_tr">
      ...
      <td>
        ...
        <input type="button" value="返回" onClick="location.href='friendlink_type_list.php?type=<?php echo $type?>'" class="edit_but unselect">
      </td>
    </tr>
  </table>
</form>
