...
SetSysEvent('products_piliang');//添加日志功能
?>
<!doctype html>
<html>
<head>
...
function challs_flash_update(){
	...
	a.FormID = ['select','select2','content'];
...
<div id="li1"> 图文类别：
  <select id="select" size="1">
    <?php echo get_products_type(0,$c_id,$_GET['lanmu'])?>
  </select>
</div>
<div class="liubai"></div>
<div id="li2"> 内容：
  <textarea id="content" cols="1" rows="5"></textarea>
</div>
<div class="liubai"></div>
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="880" height="400" id="update" align="middle">
  <param name="allowFullScreen" value="false" />
  <param name="allowScriptAccess" value="always" />
  <param name="movie" value="update.swf" />
  <param name="quality" value="high" />
  <param name="bgcolor" value="#ffffff" />
  <embed src="update.swf" quality="high" bgcolor="#ffffff" width="880" height="400" name="update" align="middle" allowscriptaccess="always"
