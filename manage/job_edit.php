...
<form action="action/job_action.php" method="post" onSubmit="return add_danye_check()">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="edit_tr">
      ...
      <td><input type="text" class="edit_input" name="lc_title" id="lc_title" style="width: 555px" value="<?php echo $rows['lc_title']?>"></td>
    </tr>
    <tr class="edit_tr">
      <td class="edit_t"><span class="edit_title">招&nbsp;聘&nbsp;人&nbsp;数：</span></td>
      <td><input type="text" name="lc_num" class="edit_input" id="lc_num" style="width: 150px" value="<?php echo $rows['lc_num']?>"></td>
    </tr>
    <tr class="edit_tr">
      <td class="edit_t"><span class="edit_title">内&nbsp;&nbsp;&nbsp;&nbsp;容：</span></td>
      <td><div id="lc_content">
          <textarea name="lc_content" style="height:260px; width: 750px"><?php echo $rows['lc_content']?></textarea>
        </div></td>
    </tr>    
    <tr class="sub_tr">
