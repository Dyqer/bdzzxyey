...
<body>
<form name="add_nav_form" action="action/nav_action.php" method="post" onSubmit="return check_nav()">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="edit_tr">
      ...
      <td><input type="text" name="lc_title" class="edit_input" id="lc_title" style="width: 300px" value="<?php echo $row['lc_title']?>"><span class="ti_s">&nbsp;&nbsp;&nbsp;*</span></td>
    </tr>
    <tr class="edit_tr">
      <td class="edit_t"><span class="edit_title">导&nbsp;航&nbsp;链&nbsp;接：</span></td>
      <td><input type="text" name="lc_link_url" class="edit_input" id="lc_link_url" style="width: 200px" value="<?php echo $row['lc_link_url']?>">
      &nbsp;对&nbsp;应&nbsp;栏&nbsp;目：
    ...
    <tr class="edit_tr">
      ...
      <td><input type="text" name="lc_rwlink_url" class="edit_input" id="lc_rwlink_url" style="width: 300px" value="<?php echo $row['lc_rwlink_url']?>"></td>
    </tr>
    <tr class="edit_tr">
    ...
    <tr class="edit_tr">
      ...
      <td><input type="text" name="lc_target" id="lc_target" class="edit_input" style="width: 200px" readonly value="<?php echo $row['lc_target']?>">
    ...
    <tr class="edit_tr">
      ...
      <td><input type="text" name="lc_content" class="edit_input" id="lc_content" style="width:300px;" value="<?php echo $row['lc_content']?>"></td>
    </tr>
    <tr class="edit_tr">
