...
SetSysEvent('banner_type_edit');//添加日志功能

$id = isset($_GET['id'])?(int)$_GET['id']:0;

$sql = "select * from ".$lc."_banner_type where c_id ='{$id}'";
$rs = mysql_query($sql);
if($rs){
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="edit_tr">
      ...
      <td>
        ...
        <input type="button" value="返回" onClick="location.href='banner_type_list.php?type=<?php echo $rows['c_type']?>'" class="edit_but unselect">
      </td>
    </tr>
  </table>
</form>
